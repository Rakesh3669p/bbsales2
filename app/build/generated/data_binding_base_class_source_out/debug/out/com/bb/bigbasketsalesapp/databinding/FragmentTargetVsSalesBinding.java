...
public final class FragmentTargetVsSalesBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView targetSalesTitle;
  ...
  private FragmentTargetVsSalesBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView errorMessage, @NonNull View greenStick, @NonNull View loader,
      @NonNull Spinner monthSpinner, @NonNull View monthlyRevenueBg, @NonNull TextView newCustomer,
      @NonNull TextView newCustomer1Lbl, @NonNull View newCustomersBg,
      @NonNull ImageView newCustomersBgIcon, @NonNull TextView noOfShops,
      @NonNull TextView noOfShops1Lbl, @NonNull View noOfShopsBg,
      @NonNull ImageView noOfShopsBgIcon, @NonNull TextView noStatsMessage,
      @NonNull View purpleStick, @NonNull View redStick, @NonNull TextView targetSalesTitle,
    ...
    this.targetSalesTitle = targetSalesTitle;
  ...
  @NonNull
  public static FragmentTargetVsSalesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTargetVsSalesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_target_vs_sales, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTargetVsSalesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.targetSalesTitle;
      TextView targetSalesTitle = ViewBindings.findChildViewById(rootView, id);
      if (targetSalesTitle == null) {
        break missingId;
      }
      ...
      return new FragmentTargetVsSalesBinding((ConstraintLayout) rootView, backArrow, blueStick,
          customerRevenue, customerRevenue1Lbl, customerRevenueBg, customerRevenueBgIcon,
          customerRevenueCurrency, errorMessage, greenStick, loader, monthSpinner, monthlyRevenueBg,
          newCustomer, newCustomer1Lbl, newCustomersBg, newCustomersBgIcon, noOfShops,
          noOfShops1Lbl, noOfShopsBg, noOfShopsBgIcon, noStatsMessage, purpleStick, redStick,
          targetSalesTitle, totalNewCustomers, totalNoOfShops, totalRevenueMonthly,
