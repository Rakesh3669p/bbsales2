 ...
 */
public abstract class Hilt_ChangePasswordLogin extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangePasswordLogin() {
    super();
  }

  Hilt_ChangePasswordLogin(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChangePasswordLogin_GeneratedInjector) this.generatedComponent()).injectChangePasswordLogin(UnsafeCasts.<ChangePasswordLogin>unsafeCast(this));
    }
  }
