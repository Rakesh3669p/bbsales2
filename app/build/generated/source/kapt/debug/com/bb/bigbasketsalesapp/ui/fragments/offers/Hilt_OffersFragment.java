 ...
 */
public abstract class Hilt_OffersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OffersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OffersFragment_GeneratedInjector) this.generatedComponent()).injectOffersFragment(UnsafeCasts.<OffersFragment>unsafeCast(this));
    }
  }
