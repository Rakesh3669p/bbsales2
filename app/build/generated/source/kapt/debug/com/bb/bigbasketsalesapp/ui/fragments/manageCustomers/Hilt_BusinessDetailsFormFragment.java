 ...
 */
public abstract class Hilt_BusinessDetailsFormFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BusinessDetailsFormFragment() {
    super();
  }

  Hilt_BusinessDetailsFormFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BusinessDetailsFormFragment_GeneratedInjector) this.generatedComponent()).injectBusinessDetailsFormFragment(UnsafeCasts.<BusinessDetailsFormFragment>unsafeCast(this));
    }
  }
