 ...
 */
public abstract class Hilt_AddCustomerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddCustomerFragment() {
    super();
  }

  Hilt_AddCustomerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddCustomerFragment_GeneratedInjector) this.generatedComponent()).injectAddCustomerFragment(UnsafeCasts.<AddCustomerFragment>unsafeCast(this));
    }
  }
