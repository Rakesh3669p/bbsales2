 ...
 */
public abstract class Hilt_FollowUpListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FollowUpListFragment() {
    super();
  }

  Hilt_FollowUpListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FollowUpListFragment_GeneratedInjector) this.generatedComponent()).injectFollowUpListFragment(UnsafeCasts.<FollowUpListFragment>unsafeCast(this));
    }
  }
