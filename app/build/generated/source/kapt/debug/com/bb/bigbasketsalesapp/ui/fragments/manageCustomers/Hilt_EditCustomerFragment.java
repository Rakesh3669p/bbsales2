 ...
 */
public abstract class Hilt_EditCustomerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditCustomerFragment() {
    super();
  }

  Hilt_EditCustomerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditCustomerFragment_GeneratedInjector) this.generatedComponent()).injectEditCustomerFragment(UnsafeCasts.<EditCustomerFragment>unsafeCast(this));
    }
  }
