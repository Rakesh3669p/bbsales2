 ...
 */
public abstract class Hilt_NotificationsMessagesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationsMessagesFragment() {
    super();
  }

  Hilt_NotificationsMessagesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationsMessagesFragment_GeneratedInjector) this.generatedComponent()).injectNotificationsMessagesFragment(UnsafeCasts.<NotificationsMessagesFragment>unsafeCast(this));
    }
  }
