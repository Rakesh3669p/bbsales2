 ...
 */
public abstract class Hilt_NotificationListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationListFragment() {
    super();
  }

  Hilt_NotificationListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationListFragment_GeneratedInjector) this.generatedComponent()).injectNotificationListFragment(UnsafeCasts.<NotificationListFragment>unsafeCast(this));
    }
  }
