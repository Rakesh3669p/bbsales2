 ...
 */
public abstract class Hilt_TargetVsSalesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TargetVsSalesFragment() {
    super();
  }

  Hilt_TargetVsSalesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TargetVsSalesFragment_GeneratedInjector) this.generatedComponent()).injectTargetVsSalesFragment(UnsafeCasts.<TargetVsSalesFragment>unsafeCast(this));
    }
  }
