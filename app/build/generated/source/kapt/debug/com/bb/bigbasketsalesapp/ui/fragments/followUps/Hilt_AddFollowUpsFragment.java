 ...
 */
public abstract class Hilt_AddFollowUpsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddFollowUpsFragment() {
    super();
  }

  Hilt_AddFollowUpsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddFollowUpsFragment_GeneratedInjector) this.generatedComponent()).injectAddFollowUpsFragment(UnsafeCasts.<AddFollowUpsFragment>unsafeCast(this));
    }
  }
