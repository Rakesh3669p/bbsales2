 ...
 */
public abstract class Hilt_MessageListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MessageListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MessageListFragment_GeneratedInjector) this.generatedComponent()).injectMessageListFragment(UnsafeCasts.<MessageListFragment>unsafeCast(this));
    }
  }
