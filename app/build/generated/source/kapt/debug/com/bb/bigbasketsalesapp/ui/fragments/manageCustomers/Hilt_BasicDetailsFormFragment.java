 ...
 */
public abstract class Hilt_BasicDetailsFormFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BasicDetailsFormFragment() {
    super();
  }

  Hilt_BasicDetailsFormFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BasicDetailsFormFragment_GeneratedInjector) this.generatedComponent()).injectBasicDetailsFormFragment(UnsafeCasts.<BasicDetailsFormFragment>unsafeCast(this));
    }
  }
