 ...
 */
public abstract class Hilt_RevenueFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RevenueFragment() {
    super();
  }

  Hilt_RevenueFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RevenueFragment_GeneratedInjector) this.generatedComponent()).injectRevenueFragment(UnsafeCasts.<RevenueFragment>unsafeCast(this));
    }
  }
