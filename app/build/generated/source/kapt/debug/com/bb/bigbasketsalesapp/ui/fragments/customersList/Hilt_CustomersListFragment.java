 ...
 */
public abstract class Hilt_CustomersListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CustomersListFragment() {
    super();
  }

  Hilt_CustomersListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomersListFragment_GeneratedInjector) this.generatedComponent()).injectCustomersListFragment(UnsafeCasts.<CustomersListFragment>unsafeCast(this));
    }
  }
